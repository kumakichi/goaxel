...
/* TODO: get https header */
func (https *HTTPS) Response() {
...
func (https *HTTPS) Get(url string, range_from, range_to int) {
    ...
    if range_to == 0 {
        ...
        https.AddHeader(fmt.Sprintf("Range: bytes=%d-%d", range_from, range_to))
    }
